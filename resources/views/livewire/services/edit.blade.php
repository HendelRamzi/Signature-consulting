            ...
            <form>
              <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" value="{{$service->name}}" wire:model="service.name" class="form-control" id="name" placeholder="Service 01">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="email" wire:model="service.desc" class="form-control" id="desc" placeholder="Message ici!"></textarea>
                    @error('service.desc') <span class="text-danger">{{ $message }}</span> @enderror
